...
def main(model_name, predictor_problem, dataset_name, test_problems, test_problems_name):
    ...
    # Get SVM output for the predictor problem
    svm_output = get_svm_output(
        model_name, predictor_problem, dataset_name, 
        test_problems_name, mds=True
    )
    print(svm_output)

    # Create the plot, and save it
    do_plot_emb(model_name, predictor_problem, dataset_name, 
        test_problems, test_problems_name, svm_output
    )
...
# # Can SVM reproduce overall model accuracy using hidden layer embedding, for PSVRT dataset too?
